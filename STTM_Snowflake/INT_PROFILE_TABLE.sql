...
create or replace TRANSIENT TABLE STAR_DEV.SEMANTIC_MAPPING.PROFILER_DISTRIBUTION_LOG (
	MESSAGE VARCHAR(5000),
	PROFILED_AT TIMESTAMP_NTZ(9) DEFAULT CURRENT_TIMESTAMP(),
	TABLE_NAME VARCHAR(255)
);

create or replace TRANSIENT TABLE STAR_DEV.SEMANTIC_MAPPING.INT_PROFILE (
	PROFILE_COLUMN VARCHAR(255),
	SOURCE_SCHEMA VARCHAR(255),
	SOURCE_TABLE VARCHAR(255),
	ORDINAL_POSITION NUMBER(38,0),
	DECLARED_DATA_TYPE VARCHAR(16777216),
	NULLABLE VARCHAR(3),
	MAX_LENGTH NUMBER(38,0),
	COLUMN_CLASS VARCHAR(11),
	NUM_ROWS NUMBER(18,0),
	NON_NULL_COUNT NUMBER(18,0),
	NON_NULL_RATE NUMBER(24,6),
	...
	TOP_VALUES ARRAY,
	MODAL_VALUE_RATE NUMBER(24,6),
	N NUMBER(18,0),
	MEAN_VAL NUMBER(38,6),
	STDDEV_VAL FLOAT,
	MIN_VALUE_NUM NUMBER(38,0),
	MAX_VALUE_NUM NUMBER(38,0),
	SKEWNESS FLOAT,
	ENTROPY_SCORE FLOAT
);
...
CALL INT_TABLE_PROFILE('STAR','DIM_MODEL','DIM_PATIENT');
