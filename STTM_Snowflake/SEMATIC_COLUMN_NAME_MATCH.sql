...
WITH SOURCE_RAW AS(
    ...
    FROM 
        GGASTRO.INFORMATION_SCHEMA.COLUMNS
    WHERE --WHAT IS TRUE GGASTRO SOURCE TABLE SET?
      ...
      AND table_name NOT IN ('STG_ARK_MEDICATIONRECONCILLATION_2022',
                             'STG_BILLINGCHARGETRANSACTIONADJUSTMENTDETAIL_BAD',
                             'STG_DHAT_DATA_LOAD_TEST_2020',
                             'STG_DHAT_DATA_LOAD_TEST_2021',
                             'STG_DHAT_DATA_LOAD_TEST_JAN_2021',
                             'STG_ADH_HISTORICAL_LOAD',
                             'STG_PATIENTTEST',
                             'STG_TEST08272024')
