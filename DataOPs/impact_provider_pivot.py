...
prior_db='Fullwell_20210131'
current_db='Fullwell_20210228'
table=client_id+'_CUR_'+data_type+source+'_vol'
vol_key=[by_var,'Yr','Mon']

#Connect
cur_con = sqlite3.connect("H:\\SPC-QA\\"+current_db+"_summ.sqlite")
pri_con = sqlite3.connect("H:\\SPC-QA\\"+prior_db+"_summ.sqlite")
...
final_srt=final_filtered.sort_values('Yr_Mon',ascending=[True],inplace=False)
...
pivot_ui( pivot_ready
         ...
         ,vals=['value']
         ,aggregatorName='Sum'
         ,outfile_path="C:\\Users\\camendol\\Documents\\Impact_Test_Vol.html")    
