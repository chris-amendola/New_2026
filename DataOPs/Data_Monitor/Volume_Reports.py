...
by_var='plan_source'
volume_cols=['numrows','distinct','amt_pay','amt_req','amt_all','met_qty']
...
dashboard = open("\\\\apswp2286\\w\\camendol\\SPC\\Vol_Reps\\"+client+'\\'+source+'\\'+data_type+"_Volume_Report"+review+".html", 'w')
